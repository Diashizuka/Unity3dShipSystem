...
namespace RVO
{
    ...
    public class Simulator
    {
        ...
        public int addAgent(Vector2 position)
        {
            ...
            agent.accelerated_ = defaultAgent_.accelerated_;
            agent.angularSpeed_ = defaultAgent_.angularSpeed_;
            agent.minSpeedToTurn_ = defaultAgent_.minSpeedToTurn_;
            agents_.Add(agent);
            workers_ = null;
            return agent.id_;
        }
     ...
     * <param name="velocity">The initial two-dimensional linear velocity of
     * this agent.</param>
     * <param name="accelerated">The accelerated velocity of
     * this agent.</param> 
     * <param name="angularSpeed">The angular velocity of
     * this agent.</param>
     * <param name="></param>
     */
        public int addAgent(Vector2 position, float neighborDist, int maxNeighbors, float timeHorizon, float timeHorizonObst, float radius, float maxSpeed, Vector2 velocity, float accelerated, float angularSpeed, float minSpeedToTurn)
        {
            Agent agent = new Agent();
            agent.id_ = agents_.Count;
            agent.maxNeighbors_ = maxNeighbors;
            ...
            agent.timeHorizonObst_ = timeHorizonObst;
            agent.velocity_ = velocity;
            agent.accelerated_ = accelerated;
            agent.angularSpeed_ = angularSpeed;
            agent.minSpeedToTurn_ = minSpeedToTurn;
            agents_.Add(agent);
            workers_ = null;
            return agent.id_;
        }
        ...
        /**
         * <summary>Retuens the accelerated velocity of a specified agent.</summary>
         * 
         * <param name="agentNo">The number of the agent whose two-dimensional
         * linear velocity is to be modified. </param>
         */
        public float getAgentAccelerated(int agentNo)
        {
            return agents_[agentNo].accelerated_;
        }
        /**
        * <summary>Retuens the angular velocity of a specified agent.</summary>
        * 
        * <param name="agentNo">The number of the agent whose two-dimensional
        * linear velocity is to be modified. </param>
        */
        public float getAgentAngularSpeed(int agentNo)
        {
            return agents_[agentNo].angularSpeed_;
        }
        /**
        * <summary>Retuens the minSpeedToTurn of a specified agent.</summary>
        * 
        * <param name="agentNo">The number of the agent whose two-dimensional
        * linear velocity is to be modified. </param>
        */
        public float getMinSpeedToTurn(int agentNo)
        {
            return agents_[agentNo].minSpeedToTurn_;
        }
        /**
         ...
         * <param name="accelerated">The accelerated velocity of a new agent.</param>
         * <param name="angularSpeed">The angular velocity of a new agent.</param>
         * <param name="minSpeedToTurn">The minSpeedToTurn velocity of a new agent.</param>
         */
        public void setAgentDefaults(float neighborDist, int maxNeighbors, float timeHorizon, float timeHorizonObst, float radius, float maxSpeed, Vector2 velocity, float accelerated, float angularSpeed, float minSpeedToTurn)
        {
            if (defaultAgent_ == null)
            {
            ...
            defaultAgent_.accelerated_ = accelerated;
            defaultAgent_.angularSpeed_ = angularSpeed;
            defaultAgent_.minSpeedToTurn_ = minSpeedToTurn;
        }
        ...
        /**
         * <summary>Sets the accelerated of a specified agent.</summary>
         * 
         * <param name="agentNo">The number of the agent whose two-dimensional
         * linear velocity is to be modified. </param>
         * <param name="accelerated">The accelerated velocity of a specified
         * agent.</param>
         */
        public void setAgentAccelerated(int agentNo, float accelerated)
        {
            agents_[agentNo].accelerated_ = accelerated;
        }
        /**
         * <summary>Sets the angular velocity of a specified agent.</summary>
         * 
         * <param name="agentNo">The number of the agent whose two-dimensional
         * linear velocity is to be modified. </param>
         * <param name="angularSpeed">The angular velocity of a specified
         * agent.</param>
         */
        public void setAgentAngularSpeed(int agentNo, float angularSpeed)
        {
            agents_[agentNo].angularSpeed_ = angularSpeed;
        }
        /**
        * <summary>Sets the angular velocity of a specified agent.</summary>
        * 
        * <param name="agentNo">The number of the agent whose two-dimensional
        * linear velocity is to be modified. </param>
        * <param name="minSpeedToTurn">The angular velocity of a specified
        * agent.</param>
        */
        public void setAgentMinSpeedToTurn(int agentNo, float minSpeedToTurn)
        {
            agents_[agentNo].minSpeedToTurn_ = minSpeedToTurn;
        }
        /**
